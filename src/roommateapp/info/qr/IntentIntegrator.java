...
public class IntentIntegrator {
  ...
  public static final String DEFAULT_MESSAGE =
	      "Diese APP benötigt einen Barcode Scanner. Möchten Sie diesen installieren?";
 // public static final String DEFAULT_YES = "Yes";
  ...
  public static final Collection<String> PRODUCT_CODE_TYPES = list("");//list("UPC_A", "UPC_E", "EAN_8", "EAN_13", "RSS_14");
