...
public class ActivitySettings extends Activity implements ActivityWithResponse {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		TextView title = (TextView) this.findViewById(R.id.headline_settings);
...
//        }
	...
	/**
	 * Hide the software keyboard interface.
	 */
	private void hideSoftKeyboard() {
		
		TextView email = (TextView) findViewById(R.id.etxt_eMail);
		TextView pw = (TextView) findViewById(R.id.etxt_pw);
