...
/**
 * Content handler of public file updater.
 */
public class CHandlerPublicUpdater implements ContentHandler {
	...
	/**
	 * Returns the current building object from
	 * the parsed Roommate file.
	 * 
	 * @return
	 */
	...
	/**
	 * Start parsing the Roommate file updater.
	 */
	public void startDocument() throws SAXException {
		
		if (RoommateConfig.VERBOSE) {
			System.out.println("Start checking Roommate update file..");
		}
	}

	/**
	 * Stop parsing the Roommate file updater.
	 */
	public void endDocument() throws SAXException {
		
		if (RoommateConfig.VERBOSE) {
			System.out.println("Stop checking Roommate update file..");
		}
	}
	...
	public void startElement(String uri, String localName, String qName,
		...
		if (qName.equals(FILE)) {
			...
			currentFile.setPublicStatus(true);
